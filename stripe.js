...
/******/ 	}
            module.exports = function (apikey) {
                return __webpack_require__(1)(apikey);
            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Stripe.DEFAULT_TIMEOUT = __webpack_require__(54).createServer().timeout;

	Stripe.PACKAGE_VERSION = __webpack_require__(55).version;
	...
	var resources = {
	  ...
	  Account: __webpack_require__(56),
	  Accounts: __webpack_require__(56),
	  Balance: __webpack_require__(57),
	  Charges: __webpack_require__(58),
	  Coupons: __webpack_require__(59),
	  Customers: __webpack_require__(60),
	  Disputes: __webpack_require__(61),
	  Events: __webpack_require__(62),
	  Invoices: __webpack_require__(63),
	  InvoiceItems: __webpack_require__(64),
	  Plans: __webpack_require__(65),
	  RecipientCards: __webpack_require__(66),
	  Recipients: __webpack_require__(67),
	  Refunds: __webpack_require__(2),
	  Tokens: __webpack_require__(68),
	  Transfers: __webpack_require__(69),
	  ApplicationFees: __webpack_require__(70),
	  FileUploads: __webpack_require__(71),
	  BitcoinReceivers: __webpack_require__(73),
	  Products: __webpack_require__(74),
	  Skus: __webpack_require__(75),
	  Orders: __webpack_require__(76),

	  // The following rely on pre-filled IDs:
	  CustomerCards: __webpack_require__(77),
	  CustomerSubscriptions: __webpack_require__(78),
	  ChargeRefunds: __webpack_require__(79),
	  ApplicationFeeRefunds: __webpack_require__(80),
	  TransferReversals: __webpack_require__(81),

	};

	Stripe.StripeResource = __webpack_require__(3);
	...
	Stripe.prototype = {
	  ...
	  getClientUserAgent: function(cb) {
	    if (Stripe.USER_AGENT_SERIALIZED) {
	      ...
	      Stripe.USER_AGENT.uname = "markin Parse Client" || 'UNKNOWN';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StripeResource = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	StripeResource.method = __webpack_require__(52);
	StripeResource.BASIC_METHODS = __webpack_require__(53);
	...
	StripeResource.prototype = {
	  ...
	  _request: function(method, path, data, auth, options, callback) {
	    ...
	    var headers = {
	      ...
	      'User-Agent': 'Markin - Parse based on Stripe/v1 NodeBindings/' + this._stripe.getConstant('PACKAGE_VERSION'),
	    };
	    ...
	    function makeRequest() {
	      ...
	      Parse.Cloud.httpRequest({
	        ...
	        body: requestData
	      }).then(self._responseHandler(null, callback),self._errorHandler(null, callback));
	/*
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isDebugging = __webpack_require__(16)(Promise, CapturedTrace);
	 /*jshint unused:false*/
	var createContext =
	    __webpack_require__(17)(Promise, CapturedTrace, isDebugging);
	var CatchFilter = __webpack_require__(18)(NEXT_FILTER);
	var PromiseResolver = __webpack_require__(19);
	...
	__webpack_require__(20)(Promise, PromiseArray);
	__webpack_require__(21)(Promise, INTERNAL, tryConvertToPromise, apiRejection);
	__webpack_require__(22)(Promise, INTERNAL, tryConvertToPromise);
	...
	__webpack_require__(27)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
	__webpack_require__(28)(Promise);
	__webpack_require__(29)(Promise, apiRejection, tryConvertToPromise, createContext);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tryCatch = util.tryCatch;
	var errorObj = util.errorObj;
	var keys = __webpack_require__(8).keys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stripeMethod = __webpack_require__(52);
	var utils = __webpack_require__(45);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"_args": [
			[
				"stripe",
				"/Users/matthewarkin/Developer/stripe-parse"
			]
		],
		"_from": "stripe@*",
		"_id": "stripe@4.2.0",
		...
		"_resolved": "https://registry.npmjs.org/stripe/-/stripe-4.2.0.tgz",
		"_shasum": "fefa0eea67616a5d5c78eb42b7aab72410f4a4aa",
		"_shrinkwrap": null,
		"_spec": "stripe",
		"_where": "/Users/matthewarkin/Developer/stripe-parse",
		"author": {
		...
		"directories": {},
		"dist": {
			"shasum": "fefa0eea67616a5d5c78eb42b7aab72410f4a4aa",
			"tarball": "http://registry.npmjs.org/stripe/-/stripe-4.2.0.tgz"
		},
		"engines": {
			"node": ">= v0.10.0"
		},
		"gitHead": "e2cb165ed8d2faee2c8ba2f78919bd852da26ebb",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StripeResource = __webpack_require__(3);
	var stripeMethod = StripeResource.method;
	var multipartDataGenerator = __webpack_require__(72);
